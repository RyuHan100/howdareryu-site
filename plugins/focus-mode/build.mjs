...
const out = read("component.js")
  .replace("__STYLES__", () => JSON.stringify(read("focus-mode.css")))
  .replace("__PRESCRIPT__", () => JSON.stringify(read("focus-mode-prescript.js")))
  .replace("__SCRIPT__", () => JSON.stringify(read("focus-mode-interactive.js")))

const banner = "// 자동 생성 파일. src/ 를 고친 뒤 `node build.mjs` 로 다시 만든다.\n"
const types = "export declare const FocusModeToggle: () => unknown\n"
