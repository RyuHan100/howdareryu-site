...
// gallery-page-svg.js(순수 함수)를 component.js 앞에 붙인다.
const out = (read("gallery-page-svg.js") + "\n" + read("component.js"))
  .replace("__STYLES__", () => JSON.stringify(read("gallery-page.css")))
  .replace("__SCRIPT__", () => JSON.stringify(read("gallery-page-interactive.js")))

const banner = "// 자동 생성 파일. src/ 를 고친 뒤 `node build.mjs` 로 다시 만든다.\n"
const types = "export declare const GalleryGrid: () => unknown\n"
