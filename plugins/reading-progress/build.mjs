...
const out = read("component.js")
  .replace("__STYLES__", () => JSON.stringify(read("reading-progress.css")))
  .replace("__SCRIPT__", () => JSON.stringify(read("reading-progress-interactive.js")))

const banner = "// 자동 생성 파일. src/ 를 고친 뒤 `node build.mjs` 로 다시 만든다.\n"
const types = "export declare const ReadingProgress: () => unknown\n"
